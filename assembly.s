...
main:                     						# main function label
	...
	xorl	%eax, %eax       					# set eax to zero, clears the register before use
...
#Initialize the variables
	...
	movl	%eax, -16(%rbp)  					# store the range of possible values (for the user to guess)
...
# Generate the random number
	...
	movl %eax, -12(%rbp)  						# Move the result to the memory location at -12(%rbp) (moves onto stack)
...
#Executes if the user does not guess correctly
.L2:
